/* ============================================================
   physics.js
   Shared physics constants + collision helpers used by player.js,
   weapons.js and game.js. No dependencies on other modules.
   ============================================================ */

const Physics = {
  // Base tuning values. Individual maps can override GRAVITY via
  // MAPS[id].gravityMultiplier (see game.js).
  BASE_GRAVITY: 0.62,
  JUMP_FORCE: -14.5,
  MOVE_SPEED: 4.4,
